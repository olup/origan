...
export const postgresPassword = postgresPasswordConfig || postgresPasswordResource!.result;
...
export const garageAccessKey = garageAccessKeyConfig || garageAccessKeyResource?.result;
export const garageSecretKey = garageSecretKeyConfig || garageSecretKeyResource?.result;
export const domainName = config.get("domainName") || "origan.dev";
export const registryEndpoint = config.get("registryEndpoint") || "registry.platform.origan.dev";
