...
import { imageTag, labels, registryEndpoint, resourceName } from "../config.js";
...
// ConfigMap
const runnerConfig = new kubernetes.core.v1.ConfigMap(
  "runner-config",
  {
    metadata: {
...
// Secret
const runnerSecret = new kubernetes.core.v1.Secret(
  "runner-secret",
  {
    metadata: {
...
// Deployment
const runnerDeployment = new kubernetes.apps.v1.Deployment(
  "runner",
  {
    metadata: {
...
const runnerService = new kubernetes.core.v1.Service(
  "runner-service",
  {
    metadata: {
      name: resourceName("runner"),
