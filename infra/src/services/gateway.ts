...
// Secret
const gatewaySecret = new kubernetes.core.v1.Secret(
  "gateway-secret",
  {
    metadata: {
...
// Deployment
const gatewayDeployment = new kubernetes.apps.v1.Deployment(
  "gateway",
  {
    metadata: {
...
// Service
const gatewayService = new kubernetes.core.v1.Service(
  "gateway-service",
  {
    metadata: {
      name: resourceName("gateway"),
