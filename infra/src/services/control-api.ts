...
// Secrets
const controlApiSecret = new kubernetes.core.v1.Secret(
  "control-api-secret",
  {
    metadata: {
...
// Deployment
const controlApiDeployment = new kubernetes.apps.v1.Deployment(
  "control-api",
  {
    metadata: {
...
// Service
const controlApiService = new kubernetes.core.v1.Service(
  "control-api-service",
  {
    metadata: {
      name: resourceName("control-api"),
