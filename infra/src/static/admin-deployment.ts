...
import { adminUrl, labels, namespace } from "../config.js";
...
const adminImage = new docker.Image(
  "admin-nginx",
  {
...
const adminDeployment = new kubernetes.apps.v1.Deployment(
  "admin-nginx-server",
  {
    metadata: {
...
export const adminService = new kubernetes.core.v1.Service(
  "admin-nginx-service",
  {
    metadata: {
      name: "admin-nginx-server",
