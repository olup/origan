...
export const parseableEndpoint =
  "http://parseable.platform.svc.cluster.local:8000";
export const parseableIngestEndpoint = pulumi.output(
  "http://parseable.platform.svc.cluster.local:8000/api/v1/ingest",
);
