...
class AwsClient {
  ...
  async sign(input, init) {
    ...
    if (input instanceof Request) {
      ...
      requestInit = Object.assign({ method, url, headers }, init);
    ...
    const signer = new AwsV4Signer(
      Object.assign({ url: requestInput }, requestInit, this, requestInit?.aws),
    );
    const signed = Object.assign({}, requestInit, await signer.sign());
    delete signed.aws;
    try {
